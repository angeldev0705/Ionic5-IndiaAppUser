...
export class SigninPage {
  ...
  // ngAfterViewInit(): void { this.user.setFocus(); }
  ...
  alertPhone() {
    ...
    if (this.phoneNumber.length > 10 || this.phoneNumber.length < 9 ) {
      this.showToast(this.phoneNumberHint);
      return;
    }
    if(this.phoneNumber.length == 10 && (this.countryCode == '40' || this.countryCode == '44')){
