...
export class My_portfolioPage {
  ...
  loadPortfolio() {
    this.isLoading = true;
    let subscription: Subscription = this.service.getMyPortfolio().subscribe(res => {
      this.dismissLoading();
      this.portfolios = res;
      ...
      let alert = this.alertCtrl.create({
        ...
        buttons: [{
          ...
          handler: () => {
            ...
            let subscription: Subscription = this.service.deleteMyPortfolio(portfolio.id).subscribe(res => {
              this.dismissLoading();
              this.navCtrl.pop();
            }, err => {
